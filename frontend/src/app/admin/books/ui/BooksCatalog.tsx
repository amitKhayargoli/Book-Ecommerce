        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5">
          <div>
            ...
            <p className="text-text-secondary text-sm md:text-base">
              Search and filter by title, author, genre, and verification status.
            </p>
          </div>
          <div className="text-sm text-text-secondary">
            Showing <span className="text-white font-semibold">{filteredBooks.length}</span>{" "}
      ...
      <section className="space-y-3">
        ...
        {filteredBooks.length === 0 && (
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-10 text-center">
            <p className="text-lg font-display mb-2">No books match your filters</p>
