...
export function BookPreviewCard({ data }: BookPreviewCardProps) {
  ...
  return (
    <div className="sticky top-24 space-y-6">
      <p className="text-text-secondary text-xs tracking-[0.3em] uppercase mb-4 px-2">
        Live Preview
      </p>
      ...
      <div className="group relative bg-card rounded-[32px] p-10 flex flex-col items-center overflow-hidden border border-white/5 shadow-2xl transition-all duration-500 hover:border-white/10">
        ...
        <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
          <span
            className={`px-3 py-1 text-[10px] font-black rounded-full border tracking-widest uppercase ${
          ...
          >
            {data.coverImageUrl ? (
              <div className="relative">
                ...
                />
                <div
                  className="placeholder absolute inset-0 hidden items-center justify-center bg-white/5 rounded-xl border border-white/5"
                  style={{ display: "none" }}
                >
              ...
              <div className="w-[180px] h-[260px] flex flex-col items-center justify-center bg-white/5 rounded-xl border border-white/5 text-white/10 gap-3 backdrop-blur-sm">
                ...
                <span className="text-xs uppercase font-black tracking-[0.3em] opacity-30">
                  No Cover
                </span>
              </div>
            )}
        ...
        <div className="text-center w-full relative z-10">
          ...
          <p className="text-text-secondary text-sm font-medium mb-4 opacity-60 tracking-wide uppercase text-[10px]">
            {displayAuthor}
          </p>
